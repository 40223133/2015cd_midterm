...
class Hello(object):
    ...
    第一題
    <form method=POST action=exam1>
    學號:<input type=text name=Q><br />
    <input type=submit value=send>
    </form>

    第二題
    <form method=POST action=exam2>
    ...
    '''
        ...
        return outstring
    #@+node:2015.20150330144929.1762: *3* exam1
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    def exam1(self, Q=1):
        outstring = '''
    ...
    '''
        ...
        return outstring
    #@+node:2015.20150331094055.1735: *3* exam2
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    def exam2(self, N=20, M=5, P=15):
        outstring = '''
    <!DOCTYPE html> 
    <html>
    <head>
